...
if(distance1 < 77 && distance1 > 71 && distance3 < 11 && k == 0 )
 {
	 if(distance3 < 10)
	  {car_stop();Delay(80);car_leftgo();Delay(760);k = 1;j = 1;}
 }
...
if(j == 1)
 { 
	 ...
	 if(l > 7)
	  {car_stop();Delay(80);car_leftgo();Delay(760);l = 0;} 
	 if(distance1 < 16)
	  {car_leftstop();Delay(400);j = 0;}
 }	
else
 {
	if(distance1 < 15)    
	{car_leftstop();Delay(150);}
  if(distance2 < 15)    
	{car_leftstop();Delay(150);}
	else
  {
   if(distance3 < 8.5)
	 {car_leftgo();Delay(50);car_go();Delay(130);}
   if(distance3 > 8.5)
	 {
		if(distance3 > 20 && distance3 < 240)
		{car_rightgo();Delay(100);car_go();Delay(33);}
	  else
	  {car_rightgo();Delay(70);car_go();Delay(130);}
	 }
	}	
 }	

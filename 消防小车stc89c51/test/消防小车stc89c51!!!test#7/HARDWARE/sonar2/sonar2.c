...
if(distance1 < 79 && distance1 > 70.5 && distance3 < 20 && k == 0 )
 {
	 if(distance3 < 10)
	  {car_stop();Delay(150);car_leftgo();Delay(710);k = 1;j = 1;}
 }
...
if(j == 1)
 { 
	 ...
	 if(l > 11)
	  {car_stop();Delay(150);car_leftgo();Delay(710);car_stop();Delay(150);l = 0;} 
	 if(distance1 < 30)
	  {car_stop();Delay(80);car_leftstop();Delay(400);j = 0;}
 }	
else
 {
	if(distance1 < 15)    
   ...
   if(distance3 > 8.5)
	 {
		...
		{car_rightgo();Delay(100);car_go();Delay(33);car_stop();Delay(80);}
	  else
